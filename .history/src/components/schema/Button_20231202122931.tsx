...
const buttonVariants = cva(
  "flex items-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:bg-red-600 disabled:cursor-not-allowed disabled:hover:none",
  {
    variants: {
      variant: {
        // ** FILLED
