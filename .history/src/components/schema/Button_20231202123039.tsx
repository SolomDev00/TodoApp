...
const buttonVariants = cva(
  "flex items-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:bg-red-500 disabled:cursor-not-allowed disabled:hover:bg-red-600",
  {
    variants: {
      variant: {
        // ** FILLED
